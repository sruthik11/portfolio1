...
const CONFIG = {
  ...
  resume: {
    fileUrl:
      'https://drive.google.com/file/d/1fy03gIK5SZGCA6PaoYvtAHVL6sTGQ2k4/view?usp=sharing', // Empty fileUrl will hide the `Download Resume` button.
  },
  skills: [
    'Python',
    'MySQL',
