...
const CONFIG = {
  ...
  resume: {
    fileUrl:
      'https://drive.google.com/file/d/1sqq-xLENljdipHBaQJNsehIbVc9ZY_Ty/view?usp=sharing', // Empty fileUrl will hide the `Download Resume` button.
  },
  skills: [
    'Python',
    'MySQL',
  ...
  aboutMe : {
    description : 'Passionate about technology and recently graduated with a Masters in Computer Science Engineering from the University of Colorado, Boulder. Proficient in Python, SQL, Azure, Tableau, Jupyter Notebook, Excel, Java, Android Development, and Google Cloud Platform, my skills bridge Software Engineering and Data Science. I specialize in crafting efficient software solutions and optimizing data processing for actionable insights. Experienced in leading projects with a holistic approach, I thrive on transparent communication and continuous learning. I bring a versatile perspective, whether it is software applications, end-to-end ML pipelines, or data analytics. Actively seeking roles in Data Analyst, Data Engineering, Machine Learning, and Software Engineering. Lets connect via email to explore opportunities together!',
  },
  googleAnalytics: {
