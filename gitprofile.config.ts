...
const CONFIG = {
  ...
  aboutMe : {
    description : 'Driven by an unwavering passion for technology, I am a versatile professional skilled in the realms of Data Science and Software Engineering. Currently pursuing a Master in Computer Science Engineering from the University of Colorado, Boulder, I bring a robust set of technical skills, encompassing Java, Python, SQL, Tableau, Jupyter Notebook, Microsoft Excel, Android Application Development, and GCP. My dedication to excellence is reflected in my ability to streamline data processing, optimize data visualization for analytical insights, and lead impactful projects. A problem-solving mindset and a commitment to continuous learning have been pivotal in my journey, fostering an environment of innovation and collaboration. As a natural leader, I thrive on guiding teams toward success, emphasizing transparent communication and a unified vision. My dynamic approach, combined with a deep understanding of end-to-end ML pipelines and solid programming expertise in Java and Python, positions me as a valuable asset ready to contribute meaningfully to the dynamic intersection of Data Science and Software Engineering. Proactively exploring opportunities in Software Engineering, Data Engineering, Data Analyst or Machine Learning roles set to commence in May 2024. Eager to connect with the professional community and contribute to impactful projects. Feel free to email me.',
  },
  googleAnalytics: {
